...
export default function Footer() {
  ...
  return (
    <footer class='bg-white dark:bg-gray-900'>
      ...
      <div class='py-6 px-4 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between lg:px-60'>
        <span class='text-sm text-gray-500 dark:text-gray-300 sm:text-center'>
          © 2022 <a href='https://cpdunlimited.com/'>CPDUnlimited™</a>. All
          Rights Reserved.
        </span>
